...
while True:
    ...
    dataframe = cv2.absdiff(first_frame,gray_frame_gau)
    

    thresh_fram = cv2.threshold(dataframe,60,255,cv2.THRESH_BINARY)[1]
    dilate_frame = cv2.dilate(thresh_fram,None,iterations=2)
